...
jQuery(function ($) {
    <#if isSuper>
        $("#sidebar-shortcuts-navlist").load("/sidebar_super.html",function(){$("#nav_list_3_1").addClass("active open");$("#nav_list_2").addClass("active");});
    <#else>
        $("#sidebar-shortcuts-navlist").load("/sidebar_admin.html",function(){$("#nav_list_3_1").addClass("active open");$("#nav_list_2").addClass("active");});
    </#if>
    var colorbox_params = {
        reposition: true,
        scalePhotos: true,
