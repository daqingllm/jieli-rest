...
<head>
    <meta charset="utf-8"/>
    <title>${associationName} 分组管理</title>
...
<#else>
    $("#sidebar-shortcuts-navlist").load("/sidebar_admin.html",function(){updateByAID();$("#nav_list_8").addClass("active");});
</#if>
