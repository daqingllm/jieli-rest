                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="clearfix form-actions" style="padding-left:320px;">
                            &nbsp; &nbsp; &nbsp;
                            <button class="btn btn-info" type="button" style="font-weight:bold" onclick="postAboutSystem();">
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        $("#sidebar-shortcuts-navlist").load("/sidebar_super.html",function(){updateByAID();$("#nav_list_12").addClass("active");});
