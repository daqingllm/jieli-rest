    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-identi"> 协会身份 </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="form-field-birthday" placeholder="生日" class="col-xs-10 col-sm-7"
                               style="padding-left: 7px;" value="<#if user.birthday??>${user.birthday.string('yyyy年MM月dd日')}</#if>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-xz"> 星座 </label>

                    <div class="col-sm-9">
                        <input type="text" id="form-field-xz" placeholder="星座" class="col-xs-10 col-sm-7"
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-xq"> 兴趣 </label>

                    <div class="col-sm-9">
                        <input type="text" id="form-field-xq" placeholder="兴趣" class="col-xs-10 col-sm-7"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="form-field-degree" placeholder="教育程度" class="col-xs-10 col-sm-7"
                               style="padding-left: 7px;" value="<#if user.degree==0>EMBA<#elseif user.degree==1>MBA<#elseif user.degree==2>学士<#elseif user.degree==3>硕士<#elseif user.degree==4>博士<#else>其他</#if>"/>
                    </div>
                </div>
